...
The PIN lock (`5903`) is **UI-only protection** and provides no server-side security. Anyone with access to browser storage can view the data. This is suitable for:
